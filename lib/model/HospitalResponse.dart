...
class HospitalResponse {
  ...
  factory HospitalResponse.fromJson(Map<String, dynamic> json) =>
      HospitalResponse(
        ...
        hospitalResponseShowMessages:
            List<dynamic>.from(json["_showMessages"].map((x) => x)),
        hospitalResponseShowObjectList:
            List<dynamic>.from(json["_showObjectList"].map((x) => x)),
        ...
        showObjectList:
            List<dynamic>.from(json["ShowObjectList"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "_showMessages":
            List<dynamic>.from(hospitalResponseShowMessages.map((x) => x)),
        "_showObjectList":
            List<dynamic>.from(hospitalResponseShowObjectList.map((x) => x)),
